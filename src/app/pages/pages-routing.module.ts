...
const routes: Routes = [{
  ...
  children: [
    ...
    },
    {
      ...
      loadChildren: () => import('./partidopolitico/partidopolitico.module')
        .then(m => m.PartidopoliticoModule),
    },
    {
      path : 'seguridad',
    ...
    {
      path : 'cuidadanos',
      loadChildren: () => import('./cuidadano/cuidadano.module')
        .then(m => m.CuidadanoModule),
    },
    {
      path: 'dashboard',
